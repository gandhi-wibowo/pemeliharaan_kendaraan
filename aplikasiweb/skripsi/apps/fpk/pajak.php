<div class="breadcrumb">
    ...
    <a href="<?php echo APPURL;?>/fpk/?sub=list.php&type=pajak">FPK Perpanjangan PAJAK</a> &nbsp;&raquo;&nbsp;
    Input data perpanjangan PAJAK
</div>

<?php require('info_fpk.inc.php');?>

<div class="history-block">
	<a href="<?php echo APPURL;?>/laporan/?sub=pajak.php&kendaraan=<?php echo $fpk['id_kendaraan'];?>" target="_blank"><b>Klik disini</b></a> untuk melihat history pembayaran PAJAK kendaraan periode sebelumnya.
</div>

<h4 class="content-title">Form Input Data Perpanjangan PAJAK</h4>
