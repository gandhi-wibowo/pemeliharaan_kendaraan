<div class="breadcrumb">
    ...
    <a href="<?php echo APPURL;?>/fpk/?sub=list.php&type=kir">FPK Perpanjangan KIR</a> &nbsp;&raquo;&nbsp;
    Input data perpanjangan KIR
</div>

<?php require('info_fpk.inc.php');?>

<div class="history-block">
	<a href="<?php echo APPURL;?>/laporan/?sub=kir.php&kendaraan=<?php echo $fpk['id_kendaraan'];?>" target="_blank"><b>Klik disini</b></a> untuk melihat history pembayaran KIR kendaraan periode sebelumnya.
</div>

<h4 class="content-title">Form Input Data Perpanjangan KIR</h4>
