...
<div class="breadcrumb">
    ...
    <a href="<?php echo APPURL;?>/fpk/?sub=list.php&type=stnk">FPK Perpanjangan STNK</a> &nbsp;&raquo;&nbsp;
    Input data perpanjangan STNK
</div>

<?php require('info_fpk.inc.php');?>

<div class="history-block">
	<a href="<?php echo APPURL;?>/laporan/?sub=stnk.php&kendaraan=<?php echo $fpk['id_kendaraan'];?>" target="_blank"><b>Klik disini</b></a> untuk melihat history pembayaran STNK kendaraan periode sebelumnya.
</div>

<h4 class="content-title">Form Input Data Perpanjangan STNK</h4>
