...
public class NotificationDetail extends AppCompatActivity {
    ...
    TextView IsiNotifikasi, PosisiBpkb, PosisiStnk, NamaPengguna, JenisMobil, NamaMobil,NoMobil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IsiNotifikasi = (TextView) findViewById(R.id.isiNotifikasi);
        PosisiBpkb = (TextView) findViewById(R.id.posisiBpkb);
        PosisiStnk = (TextView) findViewById(R.id.posisiStnk);
        NamaPengguna = (TextView) findViewById(R.id.namaPengguna);
        JenisMobil  = (TextView) findViewById(R.id.jenisMobil);
        NamaMobil = (TextView) findViewById(R.id.namaMobil);
        NoMobil = (TextView) findViewById(R.id.noMobil);

        Bundle b = getIntent().getExtras();
        IsiNotifikasi.setText(b.getString("notifikasi"));
        PosisiStnk.setText(b.getString("posisi_stnk"));
        PosisiBpkb.setText(b.getString("posisi_bpkb"));
        NamaPengguna.setText(b.getString("posisi_stnk"));
        JenisMobil.setText(b.getString("jenis_mobil"));
        NamaMobil.setText(b.getString("nama_mobil"));
        NoMobil.setText(b.getString("no_polisi"));
    }
